...
let quotes_array = [
    "Yeah, Marracash",
    "Sessantaquattro bars di paura, ah-ah",
    ...
    "Da dieci anni in major, ma non ho mai fatto la majorette",
    "Ho solo classici in palmarès",
    ...
    "Le stanno così bene i miei soldi sul collo",
...
function finishGame() {
  ...
  // show finishing text
  quote_text.textContent = "Clicca sul pulsante per riavviare il test.";
...
function resetValues() {
  ...
  input_area.value = "";
  quote_text.textContent = 'Clicca qui per avviare il timer';
